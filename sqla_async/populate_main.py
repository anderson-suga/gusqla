...
from sqla_async.conf.helpers import gerar_string, gerar_int, gerar_float, gerar_cor
...
from sqla_async.models.tipo_embalagem import TipoEmbalagem
from sqla_async.models.tipo_picole import TipoPicole
from sqla_async.models.ingrediente import Ingrediente
from sqla_async.models.conservante import Conservante
from sqla_async.models.revendedor import Revendedor
from sqla_async.models.lote import Lote
from sqla_async.models.nota_fiscal import NotaFiscal
...
async def populate_lote():
    ...
    # Perceba que estamos executando o commit somente no final.
    # Desta forma os 100 dados serão enviados em um único batch para o banco
    await session.commit()
    await session.close()
